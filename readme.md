...
4. С помощью команды git branch можно посмотреть, какие в проекте есть ветки и в какой из них вы сейчас находитесь.
5. Создание ветки:

git branch \<название ветки\>


6. Рекомендуемые правила именования веток

feature/\<Описание цепочки фичей, добавляемых по ветке\>
bugfix/\<Описние багов, которые правим по ветке\>

7. Для перехода в ветку:

git checkput \<Название ветки, куда переходим\>

8. Создать ветку и сразу в нее переключиться

git checkout -b \<Название ветки\>

9. Ветка указывает на коммит, который сделан в ней последним. При этом две ветки могут ссылаться на один и тот же коммит — например, если вы только что создали ветку, но ещё не успели внести в неё коммит.
